<template>
    <div class="template">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="dropdown nav-item">
                                <router-link :to="{name:'Connect'}" class="dropdown-toggle nav-link" data-toggle="dropdown">分类
                                    <b class="caret"></b>
                                </router-link>
        ...
        <div class="container connect text-center">
            <h1>联系</h1>
            <div class="row">
            ...
            <div class="row content text-left">
                <div class="col-md-6">
                    ...
                    <div class="line">
                        ...
                        <span class="line-text">{{obj.position}}</span>
                    </div>
                    <div class="line">
                        <span class="icon-wrap">
                            <img src="../assets/icon_5.png"/>
                        </span>
                        <a class="line-text" href="javascript:;">{{obj.email}}</a>
                    </div>
                    <div class="line">
                        <span class="icon-wrap">
                            <img src="../assets/icon_6.png"/>
                        </span>
                        <span class="line-text">{{obj.phone}}</span>
                    </div>
                    <div class="line">
                        <span class="icon-wrap">
                            <img src="../assets/icon_7.png"/>
                        </span>
                        <a class="line-text" href="javascript:;">{{obj.message}}</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <h4>联系方式</h4>
                    <input type="text" class="input1" placeholder="Name"/><br>
                    <input type="text" class="input1" placeholder="Email"/><br>
                    <input type="text" class="input1" placeholder="Phone"/><br>
                    <textarea type="text" class="input1 text-area" placeholder="Message..." rows="5"></textarea><br>
...
export default {
    ...
    mounted(){
        this.$axios.get("http://localhost:3000/connect").then(res=>this.obj=res.data);
    }
}
</script>
...
.btn:focus,.btn:active,.btn:link,.btn:visited{
    box-shadow: none;
}
.icon-wrap{
    display: inline-block;
