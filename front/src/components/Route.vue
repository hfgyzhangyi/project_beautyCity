<template>
    <div class="template">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="dropdown nav-item active">
                                <router-link :to="{name:'Route'}" class="dropdown-toggle nav-link" data-toggle="dropdown">分类
                                    <b class="caret"></b>
                                </router-link>
        ...
        <div class="container route">
            <h1>线路选择</h1>
            <div class="row">
                <div class="col-lg-6 budget">
                    <h4 class="mb-3">预算金额<input type="number" style="border-top: none;border-left: none;border-right: none;border-bottom: 1.5px solid #999999;outline: none;width: 20%;">RMB</h4>
                    <h4 class="mb-3">最省线路：</h4>
                    <h4 class="mb-3">最豪线路：</h4>
                    <h4 class="mb-3">最近线路：</h4>
                    <h4 class="mb-3">最优线路：</h4>
